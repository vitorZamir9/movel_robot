                    ...
                    if esqgray and mindgray and dirgray :
                        ...
                        while True:#so sai quando pegar 3 vitimaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaas
                                ...
                                if data:
                                    try:
                                        ...
                                        if detected and confianca is not None and lado:
                                            ...
                                            print("Detectado_inicial: " + detected + ", Confiança: " + conf_str + "%, Lado: " + lado)
                                            if confianca > 87.0 :
                            ...
                            while True:
                                ...
                                if data:
                                    try:
                                        ...
                                        if detected and confianca is not None and lado:
                                            conf_str = str(confianca).rstrip('0').rstrip('.') if '.' in str(confianca) else str(confianca)
                                            print("ALINHAR_COM_VITIMA: " + detected + ", Confiança: " + conf_str + "%, Lado: " + lado)
                                            if javiuantes == "meio":
                                                break
                                            if confianca > 80.0:
                                                if lado == "meio" and detected==vendoVITIMA:
                                                    print("Alinhado com a vítima!")
                                                    tanki.stop()
                                                    ev3.speaker.beep(800)
                                                    break  # Sai do loop, já está alinhado
                                                elif lado == "esquerda" and detected==vendoVITIMA:
                                                    print("Alinhando para a esquerda...")
                                                    agora = "esquerda"
                                                    # Exemplo: girar motores levemente para esquerda
                                                    motorB.stop()
                                                    motorC.stop()
                                                    motorB.stop()
                                                    motorC.stop()
                                                    ...
                                                    tanki.stop()
                                                    tanki.stop()
                                                elif lado == "direita" and detected==vendoVITIMA:
                                                    print("Alinhando para a direita...")
                                                    agora = "direita"
                                                    # Exemplo: girar motores levemente para direita
                                                    motorB.stop()
                                                    motorC.stop()
                                                    motorB.stop()
                                                    motorC.stop()
                                    ...
                                    wait(300)
                                    print("else")
                                    if agora == "esquerda" or lapooo == ("esquerda") :
                                        motorB.reset_angle(0)
                                        motorC.reset_angle(0)
                                        wait(100)
                                        motorB.dc(-100)
                                        ...
                                        motorC.stop()
                                        tanki.stop()
                                    elif agora == "direita" or lapooo == ("direita") :
                                        motorB.reset_angle(0)
                                        motorC.reset_angle(0)
                                        wait(100)
                                        motorB.dc(100)
                            ...
                            while True:
                                ...
                                ultraesquerda= retorno1[0]
                                if ultrafrente <= 200:
                                    print("esta na area de captura")
                                    prafrente=500
                                    break
                                elif ultrafrente >= 201:
                                    print("esta fora da area de captura")
                                    prafrente=1000
                                    break
                            #captura de vitma
                            servosP.desativa(1)
                        ...
                        while True:
                            ...
                            while True:
                                ...
                                if data:
                                    try:
                                        data_str = data.decode('utf-8').strip()
                                        retangulo = None
                                        lado = None  # Novo: armazena o lado detectado
                                        for line in data_str.split('\n'):
                                            line = line.strip()
                                            if not line:
                                                continue
                                            if 'Retangulo' in line:
                                                retangulo = line  # Pode ser "Retangulo Vermelho" ou "Retangulo Verde"
                                            if 'Lado:' in line:
                                                lado = line.split(':')[1].strip()  # Extrai só o valor depois de "Lado:"
                                        print("alinhando com o triangulo ate ficar no meio" + lado)
                                        if retangulo:
                                            if "Retangulo Vermelho" in retangulo:
                                                if lado == "meio":
                                                    ev3.speaker.beep(400)
                                                    vendoTRIANGULOcor = "vermelho"
                                                    vendoTRIANGULO = vendoTRIANGULO + 1
                                                    vendoTRIANGULOVERMELHO = vendoTRIANGULOVERMELHO + 1
                                                    tanki.stop()
                                                    break
                                                elif lado == "esquerda":
                                                    ev3.speaker.beep(400)
                                                    ...
                                                    tanki.stop()
                                                    tanki.stop() 
                                            elif "Retangulo Verde" in retangulo:
                                                if lado == "meio":
                                                    ev3.speaker.beep(400)
                                                    vendoTRIANGULOcor = "verde"
                                                    vendoTRIANGULO = vendoTRIANGULO + 1
                                                    vendoTRIANGULOVERDE = vendoTRIANGULOVERDE + 1
                                                    tanki.stop()
                                                    break
                                                elif lado == "esquerda":
                                                    ev3.speaker.beep(400)
                            ...
                            if vendoTRIANGULO >=1:
                                ...
                                while True: # girarr
                                    ...
                                    if tanki.state()[3] > 60:
                                        parado = 0
                                    if motorB.angle() >= 460 or parado > 20:
                                        tanki.stop()
                                        break
                                tanki.stop()
                                motorB.reset_angle(0)
                            ...
                            #########################################################################################################################################################################
                            if vendoTRIANGULOcor == "verde" and vendoTRIANGULOVERDE <= 1:
                                tanki.stop()
                                motorB.reset_angle(0)
                                motorC.reset_angle(0)
                                wait(100)
                                ...
                                tanki.turn(150)
                                tanki.stop()
                            elif vendoTRIANGULOcor == "vermelho" and vendoTRIANGULOVERMELHO <= 1:
                                tanki.stop()
                                motorB.reset_angle(0)
                                motorC.reset_angle(0)
                                wait(100)
